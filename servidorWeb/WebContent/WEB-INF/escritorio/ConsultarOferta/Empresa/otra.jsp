            ...
            <div class="row">
	            ...
	            <div class="col-10 py-4 px-3">
	                <div class="row">
	                    ...
	                    <!--Se le indica a la empresa que puede crear ofertas como estas -->
	                    <div class="col-4 py-4 aux">
	                        <div class="contenedorPostulantesPaquete">
	                            
	                            <div class="row">
	                            <h4 class="titulo text-center">Crea una oferta como esta</h4>
	                                <div class="col-4"></div>
	                                <a href='alta-oferta' class="col-3 btn btn-primary sinHipervinculo boton-follow mx-auto" type="button">Vamos</a>
	                                <div class="col-4"></div>
	                            </div>
	                        </div>
                    	</div>
