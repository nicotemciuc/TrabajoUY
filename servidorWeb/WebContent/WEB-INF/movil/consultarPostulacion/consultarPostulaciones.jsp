...
<%@ page import="publicador.DtOferta" %>
...
<html lang="es">
    ...
    <body>
		...
		<% 
            List<DtOferta> ofertas = (List<DtOferta>) request.getAttribute("postulaciones");
            ...
            *  Puede ser camibada, pero debe tener un minimo de 3 para una correcta navegacion. */
            ...
            if (ofertas != null){
                ...
                while (i < tope_ofertas) {
                    ofer = ofertas.get(i);
                    %>
                        <a href="consulta-postulacion?oferta=<%= ofer.getNombre() %>&postulante=<%= nickLog %>" class="sinHipervinculo">
                            <div class='row efectoZoom coloresOfertas centrar'>
                                ...
                                <p class="tituloOferta" id="encabezadoOferta"><%= ofer.getNombre() %></p>
                            </div>
                        </a>
                    <%
                    i++;
